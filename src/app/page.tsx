    ...
    return (
        <main className="flex min-h-[100dvh] flex-col items-center justify-center p-6 bg-black relative overflow-hidden animate-in fade-in duration-[2000ms] ease-in-out">
            ...
            <div className="max-w-md w-full space-y-12 relative z-10 flex flex-col items-center">
                {/* Logo Section */}
                <div className="relative group animate-in fade-in duration-[3000ms] delay-500 ease-in-out">
                ...
                {/* Title & Description */}
                <div className="text-center space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-[2500ms] delay-[4000ms] ease-in-out">
                ...
                {/* Actions */}
                <div className="w-full space-y-6 pt-4 animate-in fade-in slide-in-from-bottom-4 duration-[1500ms] delay-[6000ms] ease-in-out text-center">
                    <Link
                        href="/login"
