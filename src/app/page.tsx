  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center p-6 bg-black relative overflow-hidden landing-transition">
      ...
      <div className="max-w-md w-full space-y-12 relative z-10 flex flex-col items-center">
        ...
        {/* Title & Description */}
        <div className="intro-text text-center space-y-4">
        ...
        {/* Actions */}
        <div className="intro-actions w-full space-y-6 pt-4 text-center">
          <Link
            href="/login"
          ...
          >
            ...
            <span className="text-emerald-500 group-hover:text-emerald-400 underline decoration-emerald-500/30 underline-offset-4 tracking-normal">
              Regístrate aquí
            </span>
          </Link>
