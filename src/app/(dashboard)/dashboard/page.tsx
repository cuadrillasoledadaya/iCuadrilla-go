                ...
                >
                  <div className="flex justify-between items-start gap-4">
                    <div className="space-y-1 flex-1">
                      <h3 className="text-xl font-black text-neutral-900 uppercase tracking-tight leading-none line-clamp-2">
                        {evento.titulo}
                      </h3>
                    </div>
              ...
              {proximosEventos.map((_: any, idx: number) => (
                <div
                  ...
                  className={cn(
                    ...
                    idx === activeIndex ? 'bg-primary w-4' : 'bg-neutral-200'
                  )}
                />
              ))}
            </div>
            ...
            <div className="flex justify-center gap-1.5">
              {avisos.map((_: any, idx: number) => (
                <div
                  ...
                  className={cn(
                    'h-1.5 w-1.5 rounded-full transition-all duration-300',
                    idx === activeAvisoIndex ? 'bg-primary w-4' : 'bg-neutral-200'
                  )}
                />
              ))}
            </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-amber-50/50 p-7 rounded-[40px] border border-amber-100 shadow-sm flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[9px] text-amber-700 font-black uppercase tracking-tighter">
                Pendientes
              </p>
            </div>
          </div>
          ...
          <div className="bg-emerald-50/50 p-7 rounded-[40px] border border-emerald-100 shadow-sm flex flex-col items-center justify-center text-center space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-emerald-700 font-black">
                {stats.asistencias.porcentaje}% Media
              </p>
            </div>
          </div>
