  ...
  const initializeScanner = async () => {
    ...
    if (scannerRef.current) {
      try {
        ...
        // Scanner cleanup failed silently — non-critical
      }
      ...
      return () => {
        ...
        if (scannerRef.current) {
          scannerRef.current
            ...
            .catch(() => {
              // Scanner stop failed silently — non-critical
            });
          scannerRef.current = null;
        }
      };
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-4 p-6">
        ...
        <p className="text-neutral-500">
          Lo sentimos, esta función es exclusiva para administradores y capataces.
        </p>
  ...
  return (
    <div className="min-h-screen bg-background p-4 space-y-6 max-w-md mx-auto">
      <header className="relative flex items-center justify-center min-h-[64px]">
        ...
        <h2 className="text-xl font-bold text-center text-primary uppercase tracking-tight">
        ...
        {hasPermission === false && (
          <div className="text-white text-center p-6 space-y-4 z-20">
            ...
            <p className="text-[10px] text-neutral-400">
              Verifica que el navegador tenga permiso para usar la cámara y actualiza la página.
            </p>
            <Button
