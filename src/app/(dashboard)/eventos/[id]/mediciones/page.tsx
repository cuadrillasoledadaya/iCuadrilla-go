...
export default function MedicionesPage() {
  ...
  const handleAlturaChange = (
    costaleroId: string,
    field: 'altura_pre' | 'altura_post',
    value: string
  ) => {
  ...
  const filteredCostaleros = costaleros.filter(
    (c) =>
        ...
        <div className="space-y-3">
          {filteredCostaleros.map((costalero) => {
            ...
            return (
              <div
                key={costalero.id}
                className="bg-white p-4 rounded-2xl border border-black/5 shadow-sm flex flex-col gap-3"
              >
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          handleAlturaChange(costalero.id, 'altura_pre', e.target.value)
                        }
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={(e) =>
                          handleAlturaChange(costalero.id, 'altura_post', e.target.value)
                        }
