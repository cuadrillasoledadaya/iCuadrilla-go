...
import { ChevronLeft, CheckCircle2, XCircle, FileText, MoreVertical, Clock } from 'lucide-react';
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <h3 className="font-bold text-neutral-900 text-sm italic">
                    {m.nombre} {m.apellidos}
                  </h3>
                  <div className="flex items-center gap-2 mt-0.5">
                    <span className="px-1.5 py-0.5 bg-neutral-100 text-neutral-500 text-[8px] font-black uppercase rounded-md border border-black/5">
                      T-{m.trabajadera}
                    </span>
