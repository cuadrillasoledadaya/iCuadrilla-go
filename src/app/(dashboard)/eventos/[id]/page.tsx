      ...
      ? [
          {
            ...
            icon: BarChart3,
            color: 'bg-neutral-900 shadow-neutral-200',
            href: `/eventos/${params.id}/estadisticas`,
          },
          {
            label: 'ESCANEAR ASISTENCIA',
            icon: QrCode,
            color: 'bg-blue-600 shadow-blue-200',
            href: `/asistencia/scanner?evento=${params.id}`,
          },
        ]
      : []),
    {
      ...
      href: `/eventos/${params.id}/trabajaderas`,
    },
    ...(canManageEvents && evento
      ? [
          ...
          },
          {
            ...
            href: `/eventos/${params.id}/mediciones`,
          },
          {
      ...
      ? [
          {
            ...
            action: () => setShowAbsenceModal(true),
          },
        ]
      : []),
  ];
        ...
        {isCostalero && alreadyNotified && (
          ...
          >
            <CheckCircle2
              ...
              className={cn(
                'transition-colors',
                isNotificationRead ? 'text-white' : 'text-emerald-400'
              )}
            />
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-[10px] text-neutral-400 font-bold uppercase tracking-tight">
                    {stats.presentes + stats.justificados} registrados
                  </p>
                </div>
              </div>
              <ChevronRight
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white w-full max-w-md rounded-[32px] p-6 space-y-6 shadow-2xl animate-in zoom-in-95">
            ...
            <textarea
              ...
              className="w-full h-32 p-4 rounded-2xl bg-neutral-50 border border-neutral-200 text-neutral-900 font-medium text-sm focus:ring-2 focus:ring-primary/50 outline-none transition-all resize-none"
            />
            <Button
              onClick={handleConfirmAbsence}
              disabled={!absenceReason.trim() || loading}
              className="w-full h-14 rounded-xl bg-primary text-white font-black uppercase tracking-widest text-xs flex items-center justify-center gap-2"
            >
              {loading ? (
                'Enviando...'
              ) : (
