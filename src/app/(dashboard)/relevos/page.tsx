    ...
    <div className="p-6 space-y-8 bg-background min-h-screen pb-32">
      <header className="relative flex flex-col items-center justify-center min-h-[64px] text-center">
        ...
        <p className="text-[10px] text-neutral-400 font-bold uppercase tracking-widest mt-0.5">
          Selecciona dos para intercambiar
        </p>
        {selected && (
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      !c
                        ? 'bg-neutral-900/50 border-neutral-800 border-dashed cursor-default'
                        : selected?.id === c.id
                          ? 'bg-white border-white text-black scale-105 z-10 shadow-xl shadow-white/20'
