  ...
  return (
    <div className="p-6 space-y-8 bg-background min-h-screen pb-32 animate-in fade-in duration-700">
      ...
      {canManageAnnouncements && (
        <form
          onSubmit={publicar}
          className="bg-white p-6 rounded-[32px] border border-black/5 shadow-sm space-y-4 relative overflow-hidden"
        >
          ...
          <Button
            disabled={loading}
            className="w-full h-12 bg-neutral-900 hover:bg-black text-white font-black uppercase tracking-widest text-[10px] rounded-xl shadow-lg shadow-neutral-200/50 hover:shadow-xl hover:shadow-neutral-300/50 transition-all active:scale-[0.98]"
          >
      ...
      <div className="space-y-4">
        {anuncios.length === 0 ? (
          ...
          anuncios.map((a) => (
            <div
              key={a.id}
              className="bg-white p-6 rounded-[24px] border border-black/5 shadow-sm space-y-4 relative overflow-hidden group hover:shadow-md transition-all duration-300"
            >
              ...
              <div className="flex items-start justify-between gap-4 pl-2">
                <div className="space-y-3 flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-extrabold text-lg text-neutral-900 leading-tight uppercase tracking-tight">
                        {a.titulo}
                      </h3>
                  ...
                  <div className="pl-[52px]">
                    <p className="text-sm text-neutral-600 leading-relaxed whitespace-pre-wrap font-medium">
                      {a.contenido}
                    </p>
                  </div>
                </div>
