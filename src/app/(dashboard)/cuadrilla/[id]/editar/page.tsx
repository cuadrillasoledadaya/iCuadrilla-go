  ...
  return (
    <div className="p-6 space-y-8 pb-32 animate-in fade-in duration-700 max-w-2xl mx-auto">
      ...
      <form
        ...
        className="bg-white p-6 space-y-6 rounded-[2rem] border border-black/5 shadow-sm"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <Input
              {...register('nombre')}
              className="bg-white border-black/10 h-12 rounded-xl text-neutral-900 placeholder:text-neutral-400"
            />
        ...
        <div className="flex flex-col gap-3 pt-4">
          <Button
            type="submit"
            disabled={saving}
            className="w-full bg-primary hover:bg-primary/90 text-white font-black h-14 rounded-2xl gap-2 shadow-lg shadow-primary/20 tracking-widest text-xs"
          >
            <Save size={20} />
