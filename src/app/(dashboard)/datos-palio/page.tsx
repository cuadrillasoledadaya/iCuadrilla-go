...
export default function DatosPalioPage() {
  ...
  const handleAlturaChange = (trabajadera: number, value: string) => {
    ...
    setAlturas((prev) =>
      prev.map((a) => (a.trabajadera === trabajadera ? { ...a, altura_cm: numValue } : a))
    );
  };
  ...
  const guardarDatos = async () => {
    ...
    try {
      ...
      for (const altura of alturas) {
        await supabase.from('perfil_trabajaderas').upsert(
          {
            temporada_id: temporadaId,
      ...
      <div className="p-6 pb-0">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm font-bold text-primary">
            {temporadaActiva || 'Sin temporada activa'}
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-neutral-500 mb-4">
            Introduce la diferencia en cm de cada trabajadera respecto a la referencia (normalmente
            T1 o suelo).
          </p>
