      ...
      ? [
          {
            ...
            items: [
              ...
              ...(canManageRoles
                ? [{ label: 'Gestión de Roles', href: '/ajustes/roles', icon: Users }]
                : []),
            ],
          },
        ]
      ...
      {isLoggingOut && (
        <div className="fixed inset-0 z-[9999] bg-black animate-in fade-in duration-700 flex flex-col items-center justify-center text-center p-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-[0.3em] pt-4">
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-8 space-y-8">
          {menuGroups.map((group, idx) => (
            <div key={idx} className="space-y-4">
              {group.title && (
                <h3 className="px-4 text-[10px] font-black text-neutral-400 uppercase tracking-[0.2em]">
                  {group.title}
                </h3>
              )}
                        ...
                        <div
                          className={cn(
                            ...
                            isActive
                              ...
                              : 'bg-neutral-100 text-neutral-400 group-hover:bg-white group-hover:text-primary'
                          )}
                        >
                          <Icon size={18} />
                        </div>
          ...
          <div className="space-y-4">
            <h3 className="px-4 text-[10px] font-black text-neutral-400 uppercase tracking-[0.2em]">
              {loadingSeasons ? 'Cargando...' : 'TEMPORADA ACTIVA'}
            </h3>
            <div className="px-4">
              <button
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={cn('transition-transform', seasonsOpen && 'rotate-180')}
                />
              </button>
