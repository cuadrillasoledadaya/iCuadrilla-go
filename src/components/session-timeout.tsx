    ...
    >
      <div className="space-y-4">
        <p className="text-neutral-300">
          Tu sesión expirará en <span className="text-gold font-bold">{timeLeft}</span> segundos por
          inactividad.
        </p>
        <p className="text-sm text-neutral-400">¿Deseas mantener tu sesión abierta?</p>
